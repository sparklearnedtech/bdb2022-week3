...
contract INO is Ownable {
    ...
    function adddNFT(uint256[] memory _nftIDs) public onlyOwner {
    ...
    function buyTokens() public payable {
        ...
        uint256 _unsoldTokens = totalNFTs - soldNFTs;
        ...
        for (uint256 x = soldNFTs; x < soldNFTs + _rewardedAmount; x++) {
        ...
        soldNFTs += _rewardedAmount;
        totalRaised += getTokenInETH(_rewardedAmount);
    }
    ...
    function withdrawRemainingTokens() external onlyOwner {
        ...
        for (uint256 x = soldNFTs; x < totalNFTs; x++) {
